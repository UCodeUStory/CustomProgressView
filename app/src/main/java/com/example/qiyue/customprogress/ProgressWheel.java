...
public class ProgressWheel extends View {
  ...
  private void setupBounds(int layout_width, int layout_height) {
   ...
   /*   circleBounds =
      ...
      int circleRight = layout_width - paddingRight;
      int circleBottom = layout_height - paddingBottom;
      ...
      circleBounds.right = circleRight - 10;                             //右边
  ...
  protected void onDraw(Canvas canvas) {
    ...
    if (isSpinning) {
      ...
      Log.i("qiyue","length="+length+"from="+from);
